...
#| fig-cap: Cross attention weights with padding mask for one input.
#| echo: false
fig, ax = plt.subplots()
ax.imshow(output[1][0].detach().numpy())

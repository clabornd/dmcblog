...
Are you ready to learn about a bunch of random stuff I've been playing around with?  "God, I hope he decided to try to get mlflow working with minio and postgresql and then use hydra to manage the configuration of the mlflow runs.  That would be so cool!" you're thinking.  Being plugged into the mind of the modern data scientist, I have delivered on your wishes, read on!
